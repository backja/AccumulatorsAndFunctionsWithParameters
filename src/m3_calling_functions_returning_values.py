...
def run_test_sum_of_digits():
    ...
    # ------------------------------------------------------------------
    expected = 10
    answer= sum_of_digits(3331)
    print("Test 2 expected:", expected)
    print("       actual:", answer)

    expected = 26
    answer= sum_of_digits(42398)
    print("Test 3 expected:", expected)
    print("       actual:", answer)

    expected = 21
    answer = sum_of_digits(5367)
...
def digits_in_cube(n):
    ...
    # ------------------------------------------------------------------
    cube = n**3
    cube_sum_digits = sum_of_digits(cube)
...
def run_test_digits_in_power():
    ...
    expected = 10
    actual = digits_in_power(80,2)
    print("Test 1 expected:", expected)
    print("         actual:",actual)

    expected = 9
    actual =  digits_in_power(3,4)
    print("Test 2 expected:", expected)
    print("         actual:",actual)
...
def digits_in_power(n, k):
    ...
    # ------------------------------------------------------------------
    power = n**k
    power_sum_digits=sum_of_digits(power)
...
def fancy_sums_of_digits(n):
    ...
    x_power_y = x**y
    fancy_sum=sum_of_digits(x_power_y)
    return fancy_sum
# ----------------------------------------------------------------------
